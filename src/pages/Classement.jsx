...
export default function Classement() {
  ...
  // ── Hooks appelés inconditionnellement au top level ──────────────────────
  ...
  // ── Mode actif ───────────────────────────────────────────────────────────
  const zoneBg  = enZonePromotion ? "rgba(76,175,80,0.2)"
                : enZoneRetrogradation ? "rgba(230,81,0,0.2)"
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 12, color: "#81c784", lineHeight: 1.5 }}>
                  Enregistre tes actions dans "Aujourd'hui" pour accumuler des GreenPoints.
                </div>
              </div>
            </div>
            <button
              ...
              <div key={ligue.id} style={{
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontWeight: isActive ? 700 : 500, color: isActive ? "#a5d6a7" : "#81c784", fontSize: 13 }}>
                    Ligue {ligue.label}
                    {isActive && (
                      <span style={{ marginLeft: 8, fontSize: 10, background: "rgba(76,175,80,0.2)", color: "#a5d6a7", borderRadius: 10, padding: "1px 8px" }}>
                        Ta ligue
                      </span>
                    )}
                  </div>
